...
- Location: E:\PAVAN\Playwright_Typescript_Framework_OpencartApp\tests\LoginDataDriven.spec.ts:55:8
...
Received string:    " Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour."
    at E:\PAVAN\Playwright_Typescript_Framework_OpencartApp\tests\LoginDataDriven.spec.ts:77:34
```
...
```ts
   ...
   6 | import { HomePage } from '../pages/HomaPage';
   7 |
   8 |
